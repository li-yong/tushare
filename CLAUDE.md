...
- 市场三尺度认识框架见 `docs/tide_wave_wind.md`(潮=流动性水量/风=叙事能量/浪=价格形态;風顶潮=MIXED 负期望)— 设计或定位新指标时先问它测哪一层;姊妹心法 `docs/indicator_design_state_vs_debt.md`(GPS 不是讨债单)。
